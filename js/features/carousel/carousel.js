 ...
 * Handles carousel functionality for gallery slides
 */
 ...
 * Can be called after images are dynamically loaded
 */
export function initializeGalleryCarousel() {
...
export function initCarousel() {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCarouselIfExists);
    } else {
